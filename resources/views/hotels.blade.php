    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex p-6 bg-white border-b border-gray-200">
                    {{-- card --}}
                    @foreach ($hotels as $hotel)
                    <div class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <a href="#">
                            <img class="p-8 rounded-lg" src="https://placeimg.com/640/480/arch" alt="product image" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
